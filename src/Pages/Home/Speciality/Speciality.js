        ...
        <Container className="text-center">
            ...
            <Row xs={2} md={3} className="g-4">
                ...
                <Col>
                    ...
                    <h5 className="text-primary">Booking a Visit</h5>
                ...
                <Col>
                    ...
                    <p>We use only the most modern medical equipment, skills for modern trends and innovations introducing into our practice.</p>
                </Col>
                <Col>
